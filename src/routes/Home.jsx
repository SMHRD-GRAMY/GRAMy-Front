    ...
    <>
      ...
      <div className="w-full h-auto">
        ...
        <div className="w-full h-auto" id="productInfo">
          <div className="w-full h-[450px] bg-white flex justify-center px-20">
            <img
          ...
          <div className="w-full h-[450px] bg-[#F7F8F8] flex justify-center px-20">
            <div className="py-10">
              <p className=" text-3xl text-[#132C4D] font-semibold mb-2">
                소모 재고 통계
              </p>
          ...
          <div className="w-full h-[450px] bg-[#27A389] flex justify-center px-20">
