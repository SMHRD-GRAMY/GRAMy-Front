      ...
      <div className=" flex justify-between h-[80px] w-full">
        ...
        <div className=" flex items-center justify-evenly w-[310px]">
          {loginContext.isLogin ? (
            ...
            <Link to="/login">
              <button className="relative inline-flex items-center px-8 py-2 border border-transparent text-md leading-6 font-medium rounded-md text-white bg-blue-600 shadow-sm hover:bg-blue-500 focus:outline-none focus:border-blue-700 focus:ring focus:ring-blue-400 active:bg-blue-700 transition ease-in-out duration-150">
                로그인
              </button>
            </Link>
          )}
          {loginContext.isLogin ? (
            <div>
              <button
                className="relative inline-flex items-center px-8 py-2 border border-transparent text-md leading-6 font-medium rounded-md text-white bg-blue-600 shadow-sm hover:bg-blue-500 focus:outline-none focus:border-blue-700 focus:ring focus:ring-blue-400 active:bg-blue-700 transition ease-in-out duration-150"
